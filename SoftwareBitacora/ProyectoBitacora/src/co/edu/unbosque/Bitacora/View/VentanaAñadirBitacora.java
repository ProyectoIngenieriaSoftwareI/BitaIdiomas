...
public class VentanaAñadirBitacora extends JInternalFrame {
    ...
    private void initComponents(){
		...
		comboBoxIdioma.setModel(new DefaultComboBoxModel(new String[] {"seleccion:", "es", "in", "ti", "fran"}));
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(10)
					.addComponent(lblañadirpalabra, GroupLayout.DEFAULT_SIZE, 311, Short.MAX_VALUE)
					.addGap(85))
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap(10, Short.MAX_VALUE)
							.addComponent(campopalabra, GroupLayout.PREFERRED_SIZE, 182, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(CampopalabraTraduccion, 182, 182, 182))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(79)
							.addComponent(lblPalabra, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED, 131, Short.MAX_VALUE)
							.addComponent(lblTraduccion, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
							.addGap(50)))
					.addGap(14))
				.addGroup(groupLayout.createSequentialGroup()
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(27)
					.addComponent(lblañadirpalabra, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)
					.addGap(52)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblTraduccion, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblPalabra, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(campopalabra, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(CampopalabraTraduccion, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(30)
					.addComponent(comboBoxIdioma, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	public void cambiarIdioma(String nombreIdioma){
		  ...
		  if (nombreIdioma.equals("Tibetano")){
	        ...
	        String idiomas[]={
	        		propiedades.getProperty("seleccion"),
