...
public class VentanaAñadirBitacora extends JInternalFrame {
	...
	public void limpiar(){
		CampopalabraTraduccion.setText("");
	...
	private void initComponents() {
		...
		botonañadirpalabras.addActionListener(new ActionListener() {
		 	...
		 	ModelEstudiante me = new ModelEstudiante();
		 	 
		 	 
		 	if(me.ValidarInsercionPalabra(vo.getPalabra(), vo.getTraduccion(),ID1)==true){
		 	me.InsertarPalabras(vo); 
		 	}else{
		 	JOptionPane.showMessageDialog(null,
		 	"Revise los campos de palabra y traduccion. Inténtelo de nuevo",
		 	"Pass Error",
