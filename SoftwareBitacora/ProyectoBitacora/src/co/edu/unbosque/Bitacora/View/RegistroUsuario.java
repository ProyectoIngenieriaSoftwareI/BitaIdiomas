	...
	public RegistroUsuario() {
		...
		botonRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				DatosVO v2= new DatosVO();
			 	v2.setNombre(camponombreestu.getText());
			 	v2.setPassword(CampoContraseña.getText());
			 	v2.setApellido(campoapellidoestu.getText());
			 	v2.setUsuario(CampoNombreUsuario.getText());
			 	v2.setTipoUsuario("2");
			 	 
			 	 
			 	MySQLDatosDAO r1 = new MySQLDatosDAO();
			 	r1.InsertarUsuario(v2);
			 	limpiar();
			}
